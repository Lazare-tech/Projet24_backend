...
<section class="">
  <div class="container h-100">
    ss
    <form action="jobs.php" method="post" class="row d-flex justify-content-center align-items-center h-50">
      <div class="col-xl-7">

        <h1 class="text-dark mb-4 text-center">Create a job</h1>
